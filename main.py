...
Algorithms = ["Breadth-First Search", "Depth-First Search", "Dijkstra's Algorithm"]
algo_index = 0
...
class Map():
    ...
    def add_terrain_to_queue(self, location, g, visitor):
        ...
        elif Algorithms[algo_index] in ["Dijkstra's Algorithm"]:
            if self.get_terrain_color(location) == WHITE:
...
text_credits = Text(text="Programmed by: Harshal & Gaurav", align="right", fontsize=12, pos=(WIDTH, HEIGHT - 20), dim=(EXTENSION, 0))
